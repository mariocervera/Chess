...
{
    /*
    * The Chess board. This class is a singleton (that is, only one instance is allowed).
    */
    public class Board : Panel
    {
        public const int NUM_ROWS = 8;

        private Square[,] matrix; //The board is a matrix of buttons
        ...
        /*
         * This method performs a movement. If a piece is deleted in this movement,
         * the piece is returned by the method.
         */
